...
<html lang="en">
	<head>
		...
		<title>TNA - Long Form Page</title>
		<!-- Bootstrap core CSS -->
	...
	<html id="page-top">
		<!--TNA header will come here-->
		<!-- Header -->
		<header>
			<div class="container">
				<div class="intro-text">
					<span class="intro-heading">TECHNOLOGY AND THE FIRST WORLD WAR</span>
				</div>
			</div>
		</header>
		<body>
				...
				<div class="row">
					<div class="col-lg-12">
						<div class="section-title">
							...
							<div class="col-sm-4"><!--<img src="../images/demo/image 3.jpg" height="570" />-->Some image</div>
							<div class="col-sm-8"><img src="../images/demo/image 2.jpg" height="570" /></div>
							...
							<div class="col-sm-6"><img src="../images/demo/image 7.jpg" height="800" /></div>
							<div class="col-sm-6"><img src="../images/demo/image 8.jpg" height="800" /></div>
							<p>
							...
							<img class="full-width" src="images/demo/Image%209.jpg" alt="">
							<p>
							...
							<img class="full-width" src="images/demo/Image%2010.jpg" alt="">
							<p>
			...
			<!--<section class="full-width">
				<img src="images/demo/Image%209.jpg" alt="">
			</section>-->
		<footer><!--TNA footer will come here-->
